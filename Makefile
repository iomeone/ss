...
debug: codegen
	@echo --------------------------------------------------------------
	@echo "PURESCRIPT_PKG_SRCS is:"
	@echo  $(foreach d,$(PACKAGE_SOURCES),$(call rwildcard,$(firstword $(subst *, ,$(d))),*.purs)) 

	@echo --------------------------------------------------------------
	@echo PURESCRIPT_SRCS is:
	@echo $(call rwildcard,$(SRC)/,*.purs)
	...
	@echo --------------------------------------------------------------
	@echo COREFN_SRCS is:
	@echo $(call rwildcard,$(OUTPUT)/,corefn.json)
